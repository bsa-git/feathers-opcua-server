...
const CH_A5_TexnoMnemo1_Options = require('./CH-A5_TexnoMnemo1_Options.json');
...
let mergeResult = loMergeWith(CH_A5_XozUchet_Options, CH_A5_TexnoMnemo1_Options, customizer);
